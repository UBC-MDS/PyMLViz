...
def test_output_type():
    ...
    assert type(plot_train_valid_error('knn',
                                       X_train, y_train,
                                       X_valid, y_valid,
                                       'n_neighbors', range(1, 50))) == type(
        p), "The return type of knn is not correct."

    assert type(plot_train_valid_error('decision tree',
                                       X_train, y_train,
                                       X_valid, y_valid,
                                       'max_depth', [5, 10, 15, 20])) == type(
        p), "The return type of decision tree is not correct."
    ...
    assert type(plot_train_valid_error('svc',
                                       ...
                                       [0.00001, 0.0001, 0.001,
                                        0.01, 0.1, 1, 10])) == type(
        p), "The return type of svc is not correct."
    ...
    assert type(plot_train_valid_error('logistic regression',
                                       ...
                                       [0.00001, 0.0001, 0.001,
                                        0.01, 0.1, 1, 10])) == type(
        p), "The return type of logistic regression is not correct."

    assert type(plot_train_valid_error('random forests',
                                       X_train, y_train,
                                       X_valid, y_valid,
                                       'max_depth', [5, 10, 15, 20])) == type(
        p), "The return type of random forests is not correct."
...
def test_input_type():
    ...
    try:
        ...
        assert str(e) == "Sorry, X_train should be a " \
    ...
    try:
        ...
        assert str(e) == "Sorry, X_valid should be a " \
                         "pd.DataFrame or np.ndarray."
    ...
    try:
        ...
        assert str(e) == "Sorry, all elements in para_vec " \
    ...
    try:
        ...
        assert str(e) == "Sorry, X_train and y_train should " \
    ...
    try:
        ...
        assert str(e) == "Sorry, X_valid and y_valid should " \
                         "have the same number of rows."
    ...
    try:
        ...
        assert str(e) == "Sorry, X_train and X_valid should " \
...
def test_input_value():
    ...
    try:
        ...
        assert str(e) == "Sorry, only the hyperparameter 'n_neighbors' " \
                         "is allowed for a 'KNN' model."
    ...
    try:
        ...
        assert str(e) == "Sorry, only the hyperparameter 'max_depth' " \
                         "is allowed for a 'decision tree' model."

    try:
        plot_train_valid_error('svc',
                               X_train, y_train,
                               X_valid, y_valid,
                               'cv', [0.00001, 0.0001, 0.001,
                                      0.01, 0.1, 1, 10])
    except Exception as e:
        assert str(e) == "Sorry, only the hyperparameters, 'c' and 'gamma', " \
                         "are allowed for a 'svc' model."
    ...
    try:
        ...
        assert str(e) == "Sorry, only the hyperparameter 'c' is " \
                         "allowed for a 'logistic regression' model."
    ...
    try:
        ...
        assert str(
            e) == "Sorry, only the hyperparameters, 'max_depth' and " \
                  "'n_estimators', are allowed for a 'random forests' model."
    ...
    try:
        ...
        assert str(
            e) == "Sorry, the model_name should be chosen from 'knn', " \
